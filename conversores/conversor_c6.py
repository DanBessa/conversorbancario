...
def iniciar_processamento(pdf_path=None):
    ...
    try:
        ...
        # 1. Crie uma variável para guardar o caminho do arquivo Excel final.
        # O nome do arquivo será o mesmo do PDF, mas com a extensão .xlsx
        nome_base, _ = os.path.splitext(pdf_path) # Remove a extensão .txt
        caminho_final_excel = nome_base + ".xlsx"

        # 2. Use essa variável ao chamar a função que cria o Excel.
        # Note que mudei o nome 'transacoes.xls' para usar o nome do arquivo original.
        extrair_dados_do_pdf(pdf_path, caminho_final_excel)

        # 3. Retorne o caminho do arquivo Excel que foi salvo.
        return caminho_final_excel
